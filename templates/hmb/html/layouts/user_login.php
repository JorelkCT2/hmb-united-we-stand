...
echo '<input id="ph-modlgn-username" type="text" name="username" class="'.$d['s']['c']['inputbox.form-control'].'" tabindex="-1" placeholder="'.Text::_('MOD_LOGIN_VALUE_USERNAME') .'" />'. "\n";
echo ' </div>'. "\n";
echo ' <div class="'.$d['s']['c']['form-group'].'">'. "\n";
echo '<label class="sr-only" for="ph-modlgn-passwd">'.Text::_('JGLOBAL_PASSWORD') .'</label>'. "\n";
echo '<input id="ph-modlgn-passwd" type="password" name="password" class="'.$d['s']['c']['inputbox.form-control'].'" tabindex="-1" size="18" placeholder="'.Text::_('JGLOBAL_PASSWORD') .'" />'. "\n";
echo ' </div>'. "\n";
