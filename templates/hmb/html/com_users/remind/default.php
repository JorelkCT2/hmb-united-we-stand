<?php
/**
 * Heavy Metal Brothers — Recordar Usuario
 * Sube a: templates/rt_remnant/html/com_users/remind/default.php
 */
...
<div class="hmb-card">
    ...
    <div class="hmb-hd">
        ...
        <h1 class="hmb-title">Recordar Usuario</h1>
        <p class="hmb-sub">Recupera tu nombre de acceso</p>
        <p class="hmb-desc">Introduce tu email y te enviaremos tu nombre de usuario.</p>
    </div>
    ...
    <div class="hmb-body">
        ...
        <form action="<?php echo Route::_('index.php?option=com_users&task=remind.remind'); ?>"
    ...
    <div class="hmb-footer">
        <div class="hmb-switch-links">
            <a class="hmb-switch-link" href="https://heavymetalbrothers.com/index.php/registro/contrasena-olvidada">
