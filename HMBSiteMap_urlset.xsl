...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        ...
        <head>
            <meta charset="UTF-8"/>
            <title>Heavy Metal Brothers Sitemap</title>
            <link rel="stylesheet" href="https://www.heavymetalbrothers.com/media/com_jlsitemap/css/sitemap.min.css"/>
        </head>
        <body>
        <div class="container">
            <h1>
                Heavy Metal Brothers Sitemap            </h1>
            <p class="description">
