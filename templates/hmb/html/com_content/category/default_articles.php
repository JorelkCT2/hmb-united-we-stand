<?php
/**
 * HMB — Override listado de artículos (com_content / category / default)
 * Tarjetas con imagen de portada, efectos hover, estética rock/metal.
 */
